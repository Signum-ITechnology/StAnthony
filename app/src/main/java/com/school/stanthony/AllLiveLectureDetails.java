...
public class AllLiveLectureDetails extends AppCompatActivity {
    ...
    Runnable myRunnable2 = new Runnable() {
        ...
        public void run() {
            ...
            final ProgressDialog progress = new ProgressDialog(AllLiveLectureDetails.this);
                    ...
                    try {
                        ...
                        if (conn == null) {
                            ...
                            String query = "select Convert(varchar,date,103) date,time,section+'/'+std+'/'+div 'std',subjectname from livelecture\n" +
                                    "where academic=(select top 1 selectedaca from tbl_hrstaffnew where staffuser='"+Form1+"') and\n" +
                                    "createdby=(SELECT Staff_ID from tbl_HRStaffnew where StaffUser='"+Form1+"'\n" +
                                    "and academic=(select top 1 selectedaca from tbl_hrstaffnew where staffuser='"+Form1+"')) and month='"+month+"'";
    ...
    public void addHeaders() {
        ...
        tr = new TableRow(AllLiveLectureDetails.this);
        tr.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.MATCH_PARENT, TableRow.LayoutParams.WRAP_CONTENT));
        tr.setBackground(sd);

        /** Creating a TextView to add to the row **/

        date = new TextView(AllLiveLectureDetails.this);
        date.setText("Date");
        ...
        time = new TextView(AllLiveLectureDetails.this);
        time.setText("Time");
        ...
        std = new TextView(AllLiveLectureDetails.this);
        std.setText("Std");
        ...
        subject = new TextView(AllLiveLectureDetails.this);

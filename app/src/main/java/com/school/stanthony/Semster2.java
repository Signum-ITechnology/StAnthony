...
public class Semster2 extends AppCompatActivity {
    Connection conn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //////
        final ProgressDialog progress = new ProgressDialog(Semster2.this);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query = "select distinct(a.subjectcode),title from tblcoursemaster a, tblstudentmarksdetails b \n" +
                                ...
                                "and Acadmic_Year=(select isselected from tblstudentmaster where student_code='"+Form1+"'))and a.Acadmic_year=(select isselected from tblstudentmaster where student_code='"+Form1+"') and a.semester in(2,4) and\n" +
                ...
                if(data.size()==0){
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(Semster2.this);
    ...
    public void addHeaders() {
        ...
        tr.addView(eno1);  // Adding textView to tablerow.
        ...
        tr.addView(dob1);  // Adding textView to tablerow.

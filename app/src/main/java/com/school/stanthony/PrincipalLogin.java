        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(pwd.getText().toString().trim().equals("")){
                    ...
                    Toast.makeText(PrincipalLogin.this, "Please Enter Password", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query = "select Department from tbl_hrstaffnew where\n" +
                        ...
                        while (rs.next()) {
                            post = rs.getString("Department");
                        }
                        try {
                            upperpost=post.toUpperCase();
                            ////////////////
                            if(!upperpost.equals("PRINCIPAL")){
                                Toast.makeText(PrincipalLogin.this, "Invalid User", Toast.LENGTH_LONG).show();
                            }
                            else {
                            ...
                            Toast.makeText(PrincipalLogin.this, "Please Enter Principal ID & Password", Toast.LENGTH_LONG).show();
                        }
    ...
    public class CheckLogin extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            if (uname.trim().equals("") || password.trim().equals("")) {
                z = "Please Enter Principal Id & Password";
            }
            else {
                try {
                    ...
                    if (conn == null) {
                        ...
                        {
                            Toast.makeText(PrincipalLogin.this, "Verifying please wait...", Toast.LENGTH_SHORT).show();
                        }
                    }
                }catch (Exception e){
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        if (resultSet.next()) {
                            ...
                            z = "Please Enter Valid Principal Id & Password";
                            isSuccess = false;
                        }
                    }
                } catch (Exception e) {
        ...
        protected void onPostExecute(String r) {
            progressBar.setVisibility(View.GONE);
            Toast.makeText(PrincipalLogin.this, r, Toast.LENGTH_LONG).show();
        }
    }

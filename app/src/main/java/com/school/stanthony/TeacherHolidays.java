...
public class TeacherHolidays extends AppCompatActivity {
    Connection conn;
    ...
    Runnable myRunnable = new Runnable() {
        ...
        public void run() {
            ...
            TeacherHolidays mydata = new TeacherHolidays();
            ...
            adapter = new SimpleAdapter(TeacherHolidays.this, MyData, R.layout.holidaylistlayout, fromwhere, viewswhere);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Code = sharedPref.getString("Teachercode", null);
        ...
        try
        {
            ...
            else
            {
                String query =("select ROW_NUMBER() OVER (ORDER BY date)  AS Row,subject,today,\n" +
                        ...
                        "where Acadmic_year=(select top 1 selectedaca from tbl_HRStaffnew where staffuser='"+Code+"')") ;

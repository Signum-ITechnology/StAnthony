...
public class PrincipalLeaveManagement extends AppCompatActivity {
    ...
    private class SyncData extends AsyncTask<String, String, String> {
        ...
        {
            progress = ProgressDialog.show(PrincipalLeaveManagement.this, "Loading Details",
                    "Please Wait...", true);
        }
        ...
        protected void onPostExecute(String msg)
        {
            ...
            if (success == false)
            {
                ...
                try {
                    myAppAdapter = new MyAppAdapter(itemArrayList, PrincipalLeaveManagement.this);
...
//            }
            ...
            viewHolder.view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(finalViewHolder.pristatus.getText().toString().startsWith("0")){
                        AlertDialog.Builder builder = new AlertDialog.Builder(PrincipalLeaveManagement.this);
                        ...
                        alertDialog.show();
                    }else if(finalViewHolder.pristatus.getText().toString().startsWith("2")){
                        AlertDialog.Builder builder = new AlertDialog.Builder(PrincipalLeaveManagement.this);
                        ...
                        String staffid = staff.substring(1, 2);
                        Intent i = new Intent(PrincipalLeaveManagement.this, PrincipalLeaveStatus.class);
                        i.putExtra("id", id);

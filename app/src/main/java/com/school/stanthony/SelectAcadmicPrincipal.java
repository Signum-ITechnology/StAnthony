...
public class SelectAcadmicPrincipal extends AppCompatActivity {
    ...
    Runnable myRunnable = new Runnable() {
        ...
        public void run() {
            ...
            progress = new ProgressDialog(SelectAcadmicPrincipal.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            else
            {
                ...
                ArrayAdapter NoCoreAdapter2 = new ArrayAdapter(SelectAcadmicPrincipal.this,R.layout.spinner11, data2);
    ...
    private void loaddata() {
        ...
        if(checkaca.equals(getacademic)){
            progress.cancel();
            AlertDialog.Builder builder = new AlertDialog.Builder(SelectAcadmicPrincipal.this);
            ...
            startActivity(new Intent(SelectAcadmicPrincipal.this,HomePage5.class));
            progress.dismiss();

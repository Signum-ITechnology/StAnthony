...
public class SelectAcadmic extends AppCompatActivity {
    ...
    Runnable myRunnable = new Runnable() {
        ...
        public void run() {
            ...
            progress = new ProgressDialog(SelectAcadmic.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            {
                String query = "select b.acadmicyear from tbladmissionfeemaster a,tblcompanymaster b\n" +
                        "where applicant_type='"+Form1+"' and a.acadmic_year=b.companycode";
                ...
                ArrayAdapter NoCoreAdapter2 = new ArrayAdapter(SelectAcadmic.this,R.layout.spinner11, data2);
    ...
    private void loaddata() {
        ...
        if(checkaca.equals(getacademic)){
            progress.cancel();
            AlertDialog.Builder builder = new AlertDialog.Builder(SelectAcadmic.this);
            ...
            try {
                ...
                if (conn == null) {
                    ...
                    String commands = "update tblstudentmaster set isselected='" + getacademic + "' where student_code='" + Form1 + "'";
            ...
            startActivity(new Intent(SelectAcadmic.this,HomePage.class));
            progress.dismiss();

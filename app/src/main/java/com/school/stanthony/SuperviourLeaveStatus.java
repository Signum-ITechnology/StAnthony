...
public class SuperviourLeaveStatus extends AppCompatActivity {

    String gettext1,gettext2,gettext3,gettext4,gettext5,gettext6,getdays,getstaffid;
    TextView text1,text2,text3,text4,text5,text9,text10,approveddate;
    ...
    String getbalel,getbalcl,getbalml,getbalsl,getbaldl,getbalol;
    ...
    Runnable myRunnable = new Runnable() {
        ...
        public void run() {
            ...
            final ProgressDialog progress = new ProgressDialog(SuperviourLeaveStatus.this);
        ...
        public void run() {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SuperviourLeaveStatus.this);
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (conn == null) {
                            ...
                            String commands = "update tbl_hrappliedleave set messagehod='"+edit.getText().toString()+"',hodapprovoed='2' where id='"+getid+"' ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_superviour_leave_status);
        ...
        text10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    dpd = new DatePickerDialog(SuperviourLeaveStatus.this, new DatePickerDialog.OnDateSetListener() {
        ...
        try {
            ...
            if (conn == null) {
                ...
                String query = "select convert(varchar(10),createdon,103)'date',leavetype,leavefrom+' - '+leavetill 'leavedate',message,\n" +
                        "approvedfrom+' - '+approvedtill 'approveddate',hodapprovoed,adjustmentid,days, \n" +
        ...
        try {
            ...
            if (conn == null) {
                ...
                String commands = "update tbl_hrappliedleave set approvedfrom='"+text10.getText().toString()+"',approvedtill='"+text9.getText().toString()+"',approveddays='"+getdays+"',\n" +
                        "messagehod='"+edit.getText().toString()+"',hodapprovoed='0' where id='"+getid+"' ";
                PreparedStatement preStmt = conn.prepareStatement(commands);
                preStmt.executeUpdate();
            }
        }

...
public class PrincipalTeacherNoticeEntry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            else
            {
                ...
                ArrayAdapter NoCoreAdapter2 = new ArrayAdapter(PrincipalTeacherNoticeEntry.this,R.layout.spinner11, data2);
                ...
                try {
                    ...
                    if (conn == null)
                    {
                        ...
                        String query = "select name from tbl_hrstaffnew where\n" +
                                "acadmic_year=(select top 1 selectedaca from tbl_hrstaffnew where staffuser='"+Form1+"') and postnew='"+getdes+"'";
                        stmt = conn.prepareStatement(query);
                        rs = stmt.executeQuery();
                        ...
                        ArrayAdapter NoCoreAdapter = new ArrayAdapter(PrincipalTeacherNoticeEntry.this,android.R.layout.simple_list_item_1, data);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dpd = new DatePickerDialog(PrincipalTeacherNoticeEntry.this,
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getdes=dept.getSelectedItem().toString();
                //  Toast.makeText(PrincipalTeacherNoticeEntry.this, ""+getdes, Toast.LENGTH_SHORT).show();
                if(subject.getText().toString().equals("")){
                    AlertDialog.Builder builder = new AlertDialog.Builder(PrincipalTeacherNoticeEntry.this);
                    ...
                    final ProgressDialog progress = new ProgressDialog(PrincipalTeacherNoticeEntry.this);

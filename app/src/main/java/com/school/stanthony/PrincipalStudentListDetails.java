...
public class PrincipalStudentListDetails extends AppCompatActivity {
    ...
    String ConnectionResult,Form1,prinaca;
    ...
    Runnable myRunnable = new Runnable() {
        ...
        public void run() {
            ...
            PrincipalStudentListDetails mydata = new PrincipalStudentListDetails();
            MyData = mydata.replacetoast(prinaca,Form1);
            ...
            ADAhere = new SimpleAdapter(PrincipalStudentListDetails.this, MyData, R.layout.listtemplate2, fromwhere, viewswhere);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prinaca = sharedPref.getString("Principalcode", null);
        ...
        try {
            ...
            if (conn == null) {
                ...
                String query = "select a.surname+' '+a.name+' '+a.father_name 'name',a.father_name,a.mother_name,Student_Code,Per_Address,CONVERT(varchar(10),Birth_Date,103)Birth_Date,\n" +
                        ...
                        "and b.Acadmic_Year=(select top 1 selectedaca from tbl_hrstaffnew where staffuser='"+aca+"')and Student_Code='"+code+"'";

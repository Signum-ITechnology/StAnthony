...
public class StudentNoticeReport extends AppCompatActivity {
    ...
    Runnable myRunnable = new Runnable() {
        ...
        public void run() {
            ...
            StudentNoticeReport mydata = new StudentNoticeReport();
            ...
            adapter = new SimpleAdapter(StudentNoticeReport.this, MyData, R.layout.noticelist, fromwhere, viewswhere);
        ...
        try
        {
            ...
            else
            {
                String query = "select  ROW_NUMBER() OVER (ORDER BY issuedate desc )  AS Row,CONVERT(varchar(10),issuedate,103)issuedate,section,std+'/'+div 'class',\n" +
                        ...
                        "and acadmic_year=(select selectedaca from tblusermaster where username='"+Code+"')\n" +
                        "union all\n" +
                        ...
                        "and a.acadmic_year=(select selectedaca from tblusermaster where username='"+Code+"')\n" +

...
public class PrincipalStudentNoticeEntry extends AppCompatActivity {
    ...
    String ConnectionResult,code,section, std, div,startdate,getnotice,getacademic,getsubject,getsub,nstd;
    Boolean isSuccess;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dpd = new DatePickerDialog(PrincipalStudentNoticeEntry.this,
...
//                                start.setText((monthOfYear + 1) + "-" + dayOfMonth + "-" + year);
        ...
        try {
            ...
            else
            {
                ...
                ArrayAdapter NoCoreAdapter2 = new ArrayAdapter(PrincipalStudentNoticeEntry.this,R.layout.spinner11, data2);
                ...
                try {
                    ...
                    if (conn == null)
                    {
                        ...
                        String query = "select Applicant_type from tbladmissionfeemaster where Batch_Code ='"+section+"' and Class_Name='"+std+"'\n" +
                                "and Division='"+div+"' and Acadmic_Year=(select top 1 selectedaca from tbl_hrstaffnew where staffuser='"+Form1+"')";
                        stmt = conn.prepareStatement(query);
                        rs = stmt.executeQuery();
                        ...
                        ArrayAdapter NoCoreAdapter = new ArrayAdapter(PrincipalStudentNoticeEntry.this,android.R.layout.simple_list_item_1, data);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(subject.getText().toString().equals("")){
                    ...
                    final ProgressDialog progress = new ProgressDialog(PrincipalStudentNoticeEntry.this);

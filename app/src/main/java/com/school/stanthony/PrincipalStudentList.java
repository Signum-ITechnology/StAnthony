    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            else
            {
                ...
                ArrayAdapter NoCoreAdapter2 = new ArrayAdapter(PrincipalStudentList.this,R.layout.spinner11, data2);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (s1.getSelectedItem().toString().trim().equalsIgnoreCase("Select Section")) {
                    Toast.makeText(PrincipalStudentList.this, "Select Section", Toast.LENGTH_LONG).show();
                } else   if (s2.getSelectedItem().toString().trim().equalsIgnoreCase("Select Class")) {
                    Toast.makeText(PrincipalStudentList.this, "Select Class", Toast.LENGTH_LONG).show();
                } else   if (s3.getSelectedItem().toString().trim().equalsIgnoreCase("Select Div")) {
                    Toast.makeText(PrincipalStudentList.this, "Select Div", Toast.LENGTH_LONG).show();
                }else {
                    std = s2.getSelectedItem().toString();
                    div = s3.getSelectedItem().toString();

                    Intent i = new Intent(getApplicationContext(), PrincipalStudentListReport.class);

    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(TeacherClassTimeTable.this, "Loading Please Wait...", Toast.LENGTH_LONG).show();
                Intent i=new Intent(getApplicationContext(),TeacherMondayTimeTable.class);

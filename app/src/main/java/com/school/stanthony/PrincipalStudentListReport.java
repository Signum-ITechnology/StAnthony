...
public class PrincipalStudentListReport extends AppCompatActivity {
...
//        });
    ...
    private void makephonecall() {
        if (ContextCompat.checkSelfPermission(PrincipalStudentListReport.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED)
        {
            ActivityCompat.requestPermissions(PrincipalStudentListReport.this, new String[]{Manifest.permission.CALL_PHONE}, Request);
        }
        else{
    ...
    private class SyncData extends AsyncTask<String, String, String> {
        ...
        {
            progress = ProgressDialog.show(PrincipalStudentListReport.this, "Student List",
        ...
        {
            progress.dismiss();
            //     Toast.makeText(PrincipalStudentListReport.this, msg + "", Toast.LENGTH_LONG).show();
            if (success == false)
            {
            }
            else {
                try {
                    myAppAdapter = new MyAppAdapter(itemArrayList, PrincipalStudentListReport.this);
    ...
    public class MyAppAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent)
        {
            ...
            if (rowView == null)
            {
                ...
                viewHolder.call=rowView.findViewById(R.id.call);
            ...
            viewHolder.view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    String code=itemArrayList.get(position). getCode();
                    Intent intent=new Intent(getApplicationContext(),PrincipalStudentListDetails.class);

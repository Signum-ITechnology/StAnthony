...
public class TakeAttendanceUnconditional extends AppCompatActivity {
    ...
    Runnable myRunnable = new Runnable() {
        ...
        public void run() {
            ...
            final ProgressDialog progress = new ProgressDialog(TakeAttendanceUnconditional.this);
    ...
    public void loaddata(){
        ...
        for (int j = 0; j < getroll.size(); j++) {
            ...
            roll = new EditText(TakeAttendanceUnconditional.this);
            allEds.add(roll);
            roll.setId(id);
        ...
        for (int j = 0; j < getroll.size(); j++) {
            ...
            name = new EditText(TakeAttendanceUnconditional.this);
            allEds1.add(name);
            name.setId(id);
        ...
        for (int j = 0; j < getroll.size(); j++) {
            ...
            present = new EditText(TakeAttendanceUnconditional.this);
            allEds2.add(present);
            present.setId(id);
            present.setText("U");
            ...
            try {
                ...
                if (conn == null) {
                    ...
                    String commands = "insert into tblstudentattendencedetails (StudentCode,Roll_Number,Batch_code,Class_name,Division,Acadmic_year,Present,AttendenceDate,AttendenceMonth,created_on,created_by,Day_status)\n" +
                            "values('" + code + "','"+roll+"','" + section + "','" + section1 + "','" + section2 + "','"+section5+"','U','" + section3 + "','" + section4 + "',SYSDATETIME(),'" + createdby + "','3')";

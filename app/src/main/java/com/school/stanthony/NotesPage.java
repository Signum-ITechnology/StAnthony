...
//        setSupportActionBar(toolbar);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    NotesFragment blankFragment1=new NotesFragment();
                    return blankFragment1;

                case 1:
                    NotesPdfFragment blankFragment2=new NotesPdfFragment();
                    return blankFragment2;

                case 2:
                    NotesVideoFragment blankFragment3=new NotesVideoFragment();

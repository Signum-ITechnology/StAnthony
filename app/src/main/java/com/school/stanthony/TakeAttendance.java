...
public class TakeAttendance extends AppCompatActivity {
    ...
    Runnable myRunnable = new Runnable() {
        ...
        public void run() {
            ...
            final ProgressDialog progress = new ProgressDialog(TakeAttendance.this);
    ...
    public void loaddata(){
        ...
        for (int j = 0; j < getroll.size(); j++) {
            ...
            roll = new EditText(TakeAttendance.this);
            allEds.add(roll);
            roll.setId(id);
        ...
        for (int j = 0; j < getroll.size(); j++) {
            ...
            name = new EditText(TakeAttendance.this);
            allEds1.add(name);
            name.setId(id);
        ...
        for (int j = 0; j < getroll.size(); j++) {
            ...
            present = new EditText(TakeAttendance.this);
            allEds2.add(present);
            present.setId(id);
            present.setText("P");
            ...
            present.setKeyListener(DigitsKeyListener.getInstance("paPA"));
            present.setRawInputType(InputType.TYPE_TEXT_VARIATION_PERSON_NAME);
            ...
            try {
                ...
                if (conn == null) {
                    ...
                    String commands = "insert into tblstudentattendencedetails (StudentCode,Roll_Number,Batch_code,Class_name,Division,Acadmic_year,Present,AttendenceDate,AttendenceMonth,created_on,created_by,Day_status)\n" +
                            "values('" + code + "','"+roll+"','" + section + "','" + section1 + "','" + section2 + "','"+section5+"','"+present+"','" + section3 + "','" + section4 + "',SYSDATETIME(),'" + createdby + "','1')";

...
public class TeacherNotification extends AppCompatActivity {
    ...
    Runnable myRunnable = new Runnable() {
        ...
        public void run() {
            ...
            TeacherNotification mydata = new TeacherNotification();
            ...
            adapter = new SimpleAdapter(TeacherNotification.this, MyData, R.layout.teachernotification, fromwhere, viewswhere);

            if(adapter.getCount()==0){
                AlertDialog.Builder builder1 = new AlertDialog.Builder(TeacherNotification.this);
        ...
        try
        {
            ...
            else
            {
                String query = "select ROW_NUMBER() OVER (ORDER BY createdon)  AS Row, Convert(varchar(20),CreatedOn,103)CreatedOn,Subject,\n" +
                        ...
                        "and ForStaff!='YYY' and IsActive=1 order by CreatedOn desc";

...
//        });
    ...
    private void makephonecall() {
        if (ContextCompat.checkSelfPermission(StudentListReport.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED)
        {
            ActivityCompat.requestPermissions(StudentListReport.this, new String[]{Manifest.permission.CALL_PHONE}, Request);
        }
        else{
    ...
    private class SyncData extends AsyncTask<String, String, String> {
        ...
        {
            progress = ProgressDialog.show(StudentListReport.this, "Student List",
            ...
            try
            {
                ...
                if (conn == null)
                {
                    ...
                    String query = "select ROW_NUMBER() OVER (ORDER BY division)  AS Row, a.Class_Name+'/'+a.Division 'class',\n" +
                            ...
                            "and a.iscancelled !='1' and a.acadmic_year=(select selectedaca from tblusermaster where username='"+Form1+"') and \n" +
        ...
        {
            progress.dismiss();
            //    Toast.makeText(StudentListReport.this, msg + "", Toast.LENGTH_LONG).show();
            if (success == false)
            {
            }
            else {
                try {
                    myAppAdapter = new MyAppAdapter(itemArrayList, StudentListReport.this);
        ...
        public View getView(final int position, View convertView, ViewGroup parent)
        {
            ...
            viewHolder.view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent=new Intent(getApplicationContext(),StudentListDetails.class);

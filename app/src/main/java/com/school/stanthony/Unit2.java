...
public class Unit2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //////
        final ProgressDialog progress = new ProgressDialog(Unit2.this);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query = "select distinct(a.subjectcode),title from tblcoursemaster a, tblstudentmarksdetails b\n" +
                                ...
                                "and a.Acadmic_year=(select isselected from tblstudentmaster where student_code='"+Form1+"') and a.semester=04 and\n" +
                ...
                if(data.size()==0){
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(Unit2.this);

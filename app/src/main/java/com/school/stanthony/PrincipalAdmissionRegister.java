    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dpd = new DatePickerDialog(PrincipalAdmissionRegister.this,
...
//                                getmoonth = monthOfYear + 1;
        ...
        try {
            ...
            else
            {
                ...
                ArrayAdapter NoCoreAdapter2 = new ArrayAdapter(PrincipalAdmissionRegister.this,R.layout.spinner11, data2);
...
//        data.add(stdd);
//
//        ArrayAdapter NoCoreAdapter = new ArrayAdapter(PrincipalAdmissionRegister.this, R.layout.spinner11, data);
//        s2.setAdapter(NoCoreAdapter);
//
//        ArrayAdapter NoCoreAdapter2 = new ArrayAdapter(PrincipalAdmissionRegister.this, R.layout.spinner11, data);
...
//////////////////// student code
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Toast.makeText(PrincipalAdmissionRegister.this, ""+startdate+" "+enddate+" "+section+" "+std+" "+div+" "+code, Toast.LENGTH_LONG).show();

                if(startdate.equals("")){
                    Toast.makeText(PrincipalAdmissionRegister.this, "Please Enter Start Date", Toast.LENGTH_LONG).show();
                }else  if(enddate.equals("")){
                    Toast.makeText(PrincipalAdmissionRegister.this, "Please Enter End Date", Toast.LENGTH_LONG).show();
                }
                else {
                    Intent i = new Intent(getApplicationContext(), PrincipalAdmissionStudentsRegister.class);

        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(pwd.getText().toString().trim().equals("")){
                    ...
                    Toast.makeText(TeacherLoginPage.this, "Please Enter Password", Toast.LENGTH_SHORT).show();
                }
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        try {
                            ...
                            ////////////////
                            if(!upperpost.equals("ASST. TEACHER")){
                                Toast.makeText(TeacherLoginPage.this, "Invalid User", Toast.LENGTH_LONG).show();
                            }
                            else {
                            ...
                            Toast.makeText(TeacherLoginPage.this, "Please Enter Teacher ID & Password", Toast.LENGTH_LONG).show();
                        }
    ...
    public class CheckLogin extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            if (uname.trim().equals("") || password.trim().equals("")) {
                z = "Please Enter Teacher Id & Password";
            }
            else {
                try {
                    ...
                    if (conn == null) {
                        ...
                        {
                            Toast.makeText(TeacherLoginPage.this, "Verifying please wait...", Toast.LENGTH_SHORT).show();
                        }
                    }
                }catch (Exception e){
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        if (resultSet.next()) {
                            ...
                            z = "Please Enter Valid Teacher Id & Password";
                            isSuccess = false;
                        }
                    }
                } catch (Exception e) {
        ...
        protected void onPostExecute(String r) {
            progressBar.setVisibility(View.GONE);
            Toast.makeText(TeacherLoginPage.this, r, Toast.LENGTH_LONG).show();
        }
    }

...
public class Semster1 extends AppCompatActivity {
    Connection conn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //////
        final ProgressDialog progress = new ProgressDialog(Semster1.this);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query = "select distinct(a.subjectcode),title from tblcoursemaster a, tblstudentmarksdetails b\n" +
                                ...
                                "and Acadmic_Year=(select isselected from tblstudentmaster where student_code='"+Form1+"'))and a.Acadmic_year=(select isselected from tblstudentmaster where student_code='"+Form1+"') and a.semester in(1,3) and\n" +
                ...
                if(data.size()==0){
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(Semster1.this);
    ...
    public void addHeaders() {
        ...
        TextView Sname1 = new TextView(this);
            ...
            try {
                ...
                if (conn == null) {
                    ...
                    String query = " select distinct (select distinct title from tblcoursemaster \n" +
                            ...
                            "and Acadmic_Year=(select isselected from tblstudentmaster where student_code='"+Form1+"'))and Acadmic_Year=(select isselected from tblstudentmaster where student_code='"+Form1+"')) 'Subject', \n" +
...
//                    Toast.makeText(Semster1.this, ""+firstText, Toast.LENGTH_SHORT).show();
//                }
//            });
            ...
            if(marksper<per){
                ...
                mark.add(Integer.valueOf(eno1.getText().toString()));
                //   Toast.makeText(this, ""+mark.size(), Toast.LENGTH_SHORT).show();
            }else {
                eno1.setText(marksobt);
                eno1.setTextSize(18);
                eno1.setWidth(200);
            ...
            total.add(Integer.valueOf(dob1.getText().toString()));

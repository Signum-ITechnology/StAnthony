    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (conn == null) {
                ...
                String query = " select CONVERT(varchar(10),AttendenceDate,103)AttendenceDate,\n" +
                        "case when Present='p' then 'Present'when Present='a' then 'Absent' when Present='u' then 'Uninstructional'\n" +
                        "when Present='h' then 'Holiday' end as Present from tblstudentattendencedetails \n" +
                        "where Acadmic_year=(select isselected from tblstudentmaster where student_code='"+Form1+"') and  StudentCode='"+Form1+"' and AttendenceMonth='"+month+"' order by AttendenceDate";
                stmt = conn.prepareStatement(query);
                rs = stmt.executeQuery();
                ArrayList<String> data2 = new ArrayList<>();
                ArrayList<String> data22 = new ArrayList<>();
                while (rs.next()) {
                    String fullname = rs.getString("AttendenceDate");
                    data2.add(fullname);
                ...
                ArrayAdapter NoCoreAdapter2 = new ArrayAdapter(January.this,R.layout.spinnerdate,data2);

                String[] array22 = data22.toArray(new String[0]);
                ArrayAdapter NoCoreAdapter22 = new ArrayAdapter(January.this,R.layout.spinner,data22)
                {
                    @Override
                ...
                if(NoCoreAdapter2.getCount()==0){
                    Toast.makeText(getApplicationContext(), "Sorry No Attendance To Show ", Toast.LENGTH_LONG).show();
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query = "select CONVERT(varchar(10),AttendenceDate,103)AttendenceDate,\n" +
                                "case when Present in ('p') then 'Present' end as Present from tblstudentattendencedetails \n" +
                                "where Acadmic_year=(select isselected from tblstudentmaster where student_code='"+Form1+"') and  StudentCode='" + Form1 + "' and AttendenceMonth='" + month + "' and Present in ('p') order by AttendenceDate";
                        stmt = conn.prepareStatement(query);
                        rs = stmt.executeQuery();
                        ArrayList<String> data2 = new ArrayList<>();
                        ArrayList<String> data22 = new ArrayList<>();
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query = "select CONVERT(varchar(10),AttendenceDate,103)AttendenceDate,\n" +
                                "case when Present='a' then 'Absent' end as Present from tblstudentattendencedetails \n" +
                                "where Acadmic_year=(select isselected from tblstudentmaster where student_code='"+Form1+"') and  StudentCode='" + Form1 + "' and AttendenceMonth='" + month + "' and Present='a' order by AttendenceDate";
                        stmt = conn.prepareStatement(query);
                        rs = stmt.executeQuery();
                        ArrayList<String> data2 = new ArrayList<>();
                        ArrayList<String> data22 = new ArrayList<>();
                        ...
                        if (data2.size() == 0) {
                            ...
                            String[] array2 = data2.toArray(new String[0]);
                            ArrayAdapter NoCoreAdapter = new ArrayAdapter(January.this, R.layout.spinnerdate, data2);
//
//                            if (NoCoreAdapter.getCount() == 0) {
//                                Toast.makeText(getApplicationContext(), "Sorry No Absent Dates To Show", Toast.LENGTH_LONG).show();
//                            }
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query = "select CONVERT(varchar(10),AttendenceDate,103)AttendenceDate,\n" +
                                "case when Present='h' then 'Holiday' end as Present from tblstudentattendencedetails \n" +
                                "where Acadmic_year=(select isselected from tblstudentmaster where student_code='"+Form1+"') and  StudentCode='" + Form1 + "' and AttendenceMonth='" + month + "' and Present='h' order by AttendenceDate";
                        stmt = conn.prepareStatement(query);
                        rs = stmt.executeQuery();
                        ArrayList<String> data2 = new ArrayList<>();
                        ArrayList<String> data22 = new ArrayList<>();
                        ...
                        if (data2.size() == 0) {
                            Toast.makeText(getApplicationContext(), "Sorry No Holiday Dates To Show", Toast.LENGTH_LONG).show();
                        } else {
